...
const APPS := [
	...
	},
	{
		"id": "linkedin",
		"nombre": "LinkedOut",
		"titulo": "Tu red profesional te espera",
		"texto": "12 personas vieron tu perfil esta semana.",
		"boton": "Activar perfil",
	},
]
...
const BUFF_VAPE_MULT: float = 0.8
const BUFF_VAPE_DURACION: float = 10.0
