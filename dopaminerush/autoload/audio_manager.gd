...
const SONIDOS := {
	...
	"racha":     { "ruta": "res://assets/audio/apps/racha.ogg",     "bus": BUS_APPS, "vol": -8.0 },
	"ofertas":   { "ruta": "res://assets/audio/apps/ofertas.ogg",   "bus": BUS_APPS, "vol": -6.0 },
	"musica":    { "ruta": "res://assets/audio/apps/musica.ogg",    "bus": BUS_MUSICA, "vol": -4.0 },
	"linkedin":  { "ruta": "res://assets/audio/apps/linkedin.ogg",  "bus": BUS_APPS, "vol": -6.0 },
