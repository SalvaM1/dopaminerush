...
# Donde se abre la ventana en la pantalla, en pixeles.
# Dejar en (-1, -1) para que el escritorio la ubique solo, escalonada.
# Con las 7 apps conviene que cada una tenga su lugar fijo, asi no se tapan.
@export var posicion_ventana: Vector2 = Vector2(-1, -1)
